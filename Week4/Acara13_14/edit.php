...
include "config.php";
$id = $_GET['id'];
$sqli = mysqli_query($conn, "SELECT * FROM user_detail WHERE id='$id'");
...
if (isset($_POST["update"])) {
    ...
    $query = mysqli_query($conn, "UPDATE user_detail SET user_password='$userPass', user_fullname='$userName' WHERE id='$userId'");
    if ($query) {
